...
/*  Rota para Registro de Produtos */
 ...
 /* Rota para mostrar os itens de cada Usuario por coleção */
 Route::get('/item-perfil/{cod_colecao}', 'Produtos\ProdutosController@listaDadosUser')->name('item-perfil.listaDados');
