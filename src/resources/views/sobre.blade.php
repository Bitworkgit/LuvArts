  ...
  <script src="{{ asset("js/app.js") }}"></script>
    ...
    <div class="container">
		...
		<div class="content">
			...
			<p>Bem vindos a nossa página, nós da LuvArt's agradecemos o seu acesso, somos uma equipe com o objetivo de fazer a diferença ao mundo, 
			através de nosso site você artista pode cadastrar seu trabalho e você consumidor poderá efetuar a compra de lindas artes, ao mesmo tempo
            ambos estarão ajudando instituições de caridade que sobrevivem apenas com doações. Deste modo a equipe  LuvArt's e você estará ajudando a transformar o mundo
            em um lugar melhor.</p>
			<p>Esta plataforma tem o como objetivo auxiliar instituições de caridade, o dinheiro de cada venda sera dividido em 25% para o artista e o resto será destinado para entidades de caridade e para a manutenção da plataforma.</p>
